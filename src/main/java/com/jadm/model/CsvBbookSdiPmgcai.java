...
public class CsvBbookSdiPmgcai {
	
	private String[] csvLine;

    private CsvBbookSdiPmgcai() {
    }
    
    public CsvBbookSdiPmgcai(BbookSdiPmgcai bbooksdipmgcai) {

        setCsvLine(bbooksdipmgcai);
    ...
    public static String[] getHeader() { // getProtectedFieldsFromSuperClass() {
    	...
    	return CsvBbookSdiPmgcai.getProtectedFieldsFromClass(BbookSdiPmgcai.class);
