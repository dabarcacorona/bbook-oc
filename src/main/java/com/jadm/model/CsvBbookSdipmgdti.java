...
public class CsvBbookSdipmgdti {
	
	private String[] csvLine;

    private CsvBbookSdipmgdti() {
    }
    
    public CsvBbookSdipmgdti(BbookSdipmgdti bbooksdipmgdti) {

        setCsvLine(bbooksdipmgdti);
    ...
    public static String[] getHeader() { // getProtectedFieldsFromSuperClass() {
    	...
    	return CsvBbookSdipmgdti.getProtectedFieldsFromClass(BbookSdipmgdti.class);
