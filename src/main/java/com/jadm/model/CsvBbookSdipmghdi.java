...
public class CsvBbookSdipmghdi {

	private String[] csvLine;

    private CsvBbookSdipmghdi() {
    }
    
    public CsvBbookSdipmghdi(BbookSdipmghdi bbooksdipmghdi) {

        setCsvLine(bbooksdipmghdi);
    ...
    public static String[] getHeader() { // getProtectedFieldsFromSuperClass() {
    	...
    	return CsvBbookSdipmghdi.getProtectedFieldsFromClass(BbookSdipmghdi.class);
