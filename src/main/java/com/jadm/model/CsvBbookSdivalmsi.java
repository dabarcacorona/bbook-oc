...
public class CsvBbookSdivalmsi {

	private String[] csvLine;

    private CsvBbookSdivalmsi() {
    }
    
    public CsvBbookSdivalmsi(BbookSdiValmsi bbooksdivalmsi) {

        setCsvLine(bbooksdivalmsi);
    ...
    public static String[] getHeader() { // getProtectedFieldsFromSuperClass() {
    	...
    	return CsvBbookSdivalmsi.getProtectedFieldsFromClass(BbookSdiValmsi.class);
